...
export class NationalityService {
  ...
  apiUrlTable: string = 'Nationality';
...
//Get All
  GetAllNationality() : Observable<any> { 
    return this.httpClient.get(this.baseUrl + this.apiUrlTable+ "/GetAllNationalitys")
    .pipe(
  ...
  GetNationalityByID(id: any): Observable<any> {
    return this.httpClient.get(`${this.baseUrl + this.apiUrlTable + "/GetNationalityByID"}/${id}`).pipe(
      catchError(this.handleError)
    );
  }
  ...
  CreateNationality(data: any): Observable<any> {
    return this.httpClient.post(this.baseUrl  + this.apiUrlTable + "/AddNationality" , data).pipe(
      catchError(this.handleError)
    );
  }
