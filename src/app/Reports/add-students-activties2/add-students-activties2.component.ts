...
@Component({
  selector: 'app-add-students-activties2',
  templateUrl: './add-students-activties2.component.html',
  styleUrls: ['./add-students-activties2.component.css']
})
export class AddStudentsActivties2Component implements OnInit {
  ...
  */
  constructor(private CollegeBasicDataService: CollegeBasicDataService, private StudentsActvitesService: StudentsActvitesService,
    private dialogRef: MatDialogRef<AddStudentsActivties2Component>, fb: FormBuilder,
